if __name__ == "__main__":
  ...
  # Options common to all RL algorithms.
    ...
    parser.add_argument("--timesteps",          default=10e6,           type=float) # timesteps to run experiment for
    parser.add_argument('--discount',           default=0.9999,          type=float) # the discount factor
    ...
    parser.add_argument("--workers",            default=20,             type=int)   # how many workers to use for exploring in parallel
    ...
    parser.add_argument("--prenormalize_steps", default=1000,         type=int)   # number of samples to get normalization stats
    parser.add_argument("--sample",             default=25000,          type=int)   # how many samples to do every iteration
